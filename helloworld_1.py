...
input_size = (320, 240)
labels = ['sarna', 'dzik']
anchors = [6.94, 5.09, 6.34, 6.92, 6.94, 4.59, 6.94, 3.81, 6.84, 4.5]
...
def main(anchors, labels = None, model_addr=0x300000, sensor_window=input_size, lcd_rotation=1, sensor_hmirror=False, sensor_vflip=False):
    sensor.reset()
...
if __name__ == "__main__":
    try:
        ...
        #main(anchors = anchors, labels=labels, model_addr="/sd/model-183891.kmodel")
    except Exception as e:
